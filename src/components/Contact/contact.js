            ...
            <Row xs={1} md={1} lg={1} className="pt-4">
              <Col className="m-2">
                ...
                <p style={{ fontSize: "13px", color: "#777" }}>
                  Interest in catering services or large orders? Send us an
                  email and we will reach out to you with in 24 hours.
                </p>
              </Col>
            </Row>
          </div>
      ...
      <div className="pt-5" style={{ width: "100" }}>
        ...
        <Row className="pb-5">
          <Col className="text-center text-muted">
            ...
            <small>
              Tuesday - Wednesday: 1 pm - 9 pm <br /> Friday - Sunday 11 am - 9
              pm{" "}
            </small>
          </Col>
        </Row>
